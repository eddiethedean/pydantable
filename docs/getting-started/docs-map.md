...
- **Understand what pydantable is (mental model / ecosystem fit)**: [MENTAL_MODEL](../concepts/mental-model.md), [WHY_PYDANTABLE](../positioning/why-pydantable.md), and [COMPARISONS](../positioning/comparisons/index.md) (Polars + pandas).
- **Understand execution/materialization costs**: [EXECUTION](../user-guide/execution.md); **four plan materialization modes** (blocking / async / deferred / chunked): [MATERIALIZATION](../user-guide/materialization.md). **v2 engines:** [UPGRADING_TO_V2](../getting-started/upgrading-to-v2.md), [ENGINE_POLICY](../user-guide/engine-policy.md).
