...
The latest release on **PyPI** is **0.19.0**. This repository’s **`main`** branch tracks **0.20.0** (see `docs/changelog.md`; not necessarily published yet). Older bullets below still record the 0.5.x baseline plus later additions.
