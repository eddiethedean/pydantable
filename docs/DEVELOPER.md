...
Tag the same commit for all distributions: **`v` + version** (for example **`v1.15.1`**). **`pip install pydantable==1.15.1`** resolves **`pydantable-protocol==1.15.1`** and **`pydantable-native==1.15.1`** from PyPI.
