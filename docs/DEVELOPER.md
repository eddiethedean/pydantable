...
Tag the same commit for all distributions: **`v` + version** (for example **`v1.15.0`**). **`pip install pydantable==1.15.0`** resolves **`pydantable-protocol==1.15.0`** and **`pydantable-native==1.15.0`** from PyPI.
