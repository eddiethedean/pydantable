...
Tag the same commit for all distributions: **`v` + version** (for example **`v1.17.0`**). **`pip install pydantable==1.17.0`** resolves **`pydantable-protocol==1.17.0`** and **`pydantable-native==1.17.0`** from PyPI.
