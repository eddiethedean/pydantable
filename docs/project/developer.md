...
Tag the same commit for all distributions: **`v` + version** (for example **`v1.18.1`**). **`pip install pydantable==1.18.1`** resolves **`pydantable-protocol==1.18.1`** and **`pydantable-native==1.18.1`** from PyPI.
