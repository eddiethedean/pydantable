...
The **production-ready** **`v1.0.0`** bar—full semver policy for **patch / minor / major**, packaging checklist, support matrix, and comms—is described under **Planned v1.0.0** in {doc}`ROADMAP`. **0.19.0** is the last planned **0.x** consolidation before that gate.
