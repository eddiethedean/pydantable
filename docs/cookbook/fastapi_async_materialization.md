...
For **lazy file reads** chained before materialization, see [async_lazy_pipeline](/cookbook/async_lazy_pipeline/).
...
- **Thread pools**: you can pass a custom `executor=`; see [FASTAPI](/integrations/fastapi/fastapi/) for patterns.
