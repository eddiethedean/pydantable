...
If you need deeper I/O/materialization patterns, see [FASTAPI_ADVANCED](../../integrations/fastapi/advanced.md) and the cookbook index ([index](../../index.md)).
...
[IO_OVERVIEW](../../io/overview.md), [IO_HTTP](../../io/http.md), and the cookbook pages under [index](../../index.md).
