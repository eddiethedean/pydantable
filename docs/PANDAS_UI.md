...
This facade is **removed in strict pydantable 2.0**.
...
This page remains only as a pointer for historical 1.x docs; it does not describe a supported 2.0 surface.
