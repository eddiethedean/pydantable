...
#[pyo3(signature = (left_plan, left_root_data, right_plan, right_root_data, left_on, right_on, how, suffix, validate=None, coalesce=None, as_python_lists=false, streaming=false))]
fn execute_join(
    py: Python<'_>,
    left_plan: &PyPlan,
