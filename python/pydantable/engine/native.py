"""Default execution engine: Rust extension + Polars (``pydantable._core``)."""
...
class NativePolarsEngine:
    """Native backend: logical plans and execution via ``pydantable._core``."""
    ...
    def capabilities(self) -> Any:
        ...
        from .protocols import native_engine_capabilities
