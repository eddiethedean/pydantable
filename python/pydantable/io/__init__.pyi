...
# Parquet ``scan_kwargs`` (subset; see Rust allowlist): ``hive_partitioning``, ``hive_start_idx``,
# ``try_parse_hive_dates``, ``include_file_paths``, ``row_index_name``, ``row_index_offset``, plus
# ``n_rows``, ``glob``, ``parallel``, …
def read_parquet(
