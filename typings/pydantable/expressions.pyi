...
__all__ = ['BinaryOp', 'ColumnRef', 'CompareOp', 'Expr', 'Literal', 'WhenChain', 'coalesce', 'concat', 'dense_rank', 'global_count', 'global_max', 'global_mean', 'global_min', 'global_row_count', 'global_sum', 'lag', 'lead', 'rank', 'row_number', 'when', 'window_max', 'window_mean', 'window_min', 'window_sum']
...
class Expr:
    ...
    def over(self, partition_by: str | list[str] | tuple[str, ...] | None=None, order_by: str | list[str] | tuple[str, ...] | None=None) -> Expr:
        ...
