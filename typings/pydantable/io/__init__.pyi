...
# Parquet scan_kwargs: hive_partitioning, hive_start_idx, try_parse_hive_dates,
# include_file_paths, row_index_name, row_index_offset, plus n_rows, glob, parallel, …
def read_parquet(
    path: str | Path, *, columns: list[str] | None = None, **scan_kwargs: Any
) -> Any: ...
# CSV scan_kwargs: include_file_paths, row_index_name, row_index_offset, raise_if_empty,
# truncate_ragged_lines, decimal_comma, try_parse_dates, plus has_header, glob, …
def read_csv(
    path: str | Path, *, columns: list[str] | None = None, **scan_kwargs: Any
) -> Any: ...
def read_ndjson(
