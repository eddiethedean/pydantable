...
from app.rag.llm import ChatMessage, generate_answer
...
SYSTEM_PROMPT = """You are a helpful assistant for the Python library 'pydantable'.
 ...
 - If the context doesn't contain the answer, say what is missing and suggest where to look.
...
def rag_chat(
     *,
     ...
     retrieved = search(db_path=db_path, query_embedding=q, top_k=top_k)
