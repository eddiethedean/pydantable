...
def test_fetch_mongo_fields_limits_and_orders_columns(
...
def test_fetch_mongo_limit_and_projection(
    coll: mongomock.collection.Collection,
) -> None:
...
def test_iter_mongo_merges_keys_per_batch_sorted_union(
    coll: mongomock.collection.Collection,
) -> None:
...
def test_iter_mongo_fields_fixes_schema_and_ignores_extra_keys(
    coll: mongomock.collection.Collection,
) -> None:
...
def test_write_mongo_rejects_non_rectangular(
    coll: mongomock.collection.Collection,
) -> None:
